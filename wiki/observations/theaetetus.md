```yaml
observation_id: obs_theaetetus_0001
...
```yaml
observation_id: obs_theaetetus_0002
source_work: Theaetetus
...
```yaml
observation_id: obs_theaetetus_0003
source_work: Theaetetus
stephanus_span: 143a
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0004
source_work: Theaetetus
stephanus_span: 143a
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0007
source_work: Theaetetus
stephanus_span: 143c-143d
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
  stephanus_span: 143c-143d
  start_marker: 143c
...
```yaml
observation_id: obs_theaetetus_0008
source_work: Theaetetus
...
```yaml
observation_id: obs_theaetetus_0009
source_work: Theaetetus
stephanus_span: 143e-144a
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0010
source_work: Theaetetus
stephanus_span: 143e-144a
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0012
source_work: Theaetetus
stephanus_span: 142c-142d
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0014
source_work: Theaetetus
stephanus_span: 144b-144c
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
  stephanus_span: 144b-144c
  start_marker: 144b
  ...
  start_char: 3907
  end_char: 4748
  text_sha256: 25f4c17ef8c8bacdf8e6987819ee8682908d1f57776e09d26d6963d234ca19aa
greek_terms:
...
```yaml
observation_id: obs_theaetetus_0015
source_work: Theaetetus
stephanus_span: 144b-144c
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0016
source_work: Theaetetus
stephanus_span: 144b-144c
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0017
source_work: Theaetetus
...
textual_basis: |
  At 144d-e Socrates announces he will examine himself to see what kind of face he has, explicitly making the resemblance claim a reason to scrutinize his own face. The physical gesture of face-examination is prompted by Theodorus's comparison at 144d.
limits: |
  Does not establish that Socrates actually examines his face in the dramatic action, only that he announces the intention. The self-examination language may be playful rather than a formal philosophical procedure.
review_status: accepted
```

```yaml
observation_id: obs_theaetetus_0018
source_work: Theaetetus
stephanus_span: 144d-144e
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
textual_basis: |
  At 144e Socrates constructs a hypothetical: if each of them held a lyre and someone said the lyres were tuned alike, would they believe immediately or examine whether the speaker possessed musical expertise. Theaetetus answers they would examine first.
limits: |
  The analogy is introduced as a hypothetical thought-experiment, not a fully developed craft analogy. The point is procedural (expertise should be tested) rather than an argument about craft itself.
review_status: accepted
```

```yaml
observation_id: obs_theaetetus_0019
source_work: Theaetetus
stephanus_span: 144d-144e
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0020
dialogues: theaetetus
source_work: Theaetetus
stephanus_span: 145c-145d
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
  stephanus_span: 145c-145d
  start_marker: 145c
...
source_ref:
  ...
  start_char: 7803
  end_char: 8622
  text_sha256: 56e8541bc9e7dc52a453bdec3643c0a749ef544617f8ebc462aff0958af1de57
```

```yaml
observation_id: obs_theaetetus_0022
source_work: Theaetetus
...
```yaml
observation_id: obs_theaetetus_0023
temp_id: seg_145e_001
source_work: Theaetetus
...
```yaml
observation_id: obs_theaetetus_0024
temp_id: seg_145e_002
source_work: Theaetetus
stephanus_span: 145e-146a
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0025
temp_id: seg_145e_003
source_work: Theaetetus
stephanus_span: 145e-146a
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0026
source_work: Theaetetus
stephanus_span: 147a-147b
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
  stephanus_span: 147a-147b
  start_marker: 147a
...
textual_basis: |
  At 147a Socrates proposes a hypothetical: if someone asked what clay (pelos) is and the answer listed clay of potters, oven-makers, and brickmakers, the respondents would be laughable (geloioi). Theaetetus assents (isos). Socrates then extends the analogy to knowledge (episteme): an answer that names a craft-name when asked what knowledge is would be equally laughable (147b).
limits: |
  This passage illustrates the error of definition-by-enumeration-of-instances but does not yet state what a correct definition would require. The clay analogy is put forward as an argumentative model, not yet applied to a specific definition of knowledge.
review_status: rejected
```

```yaml
observation_id: obs_theaetetus_0027
source_work: Theaetetus
stephanus_span: 147a-147b
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
textual_basis: |
  From 147b: Socrates states that someone who does not know knowledge (episteme) does not understand knowledge of shoes (epistemen hupodematon). Theaetetus assents (ou gar). Socrates then draws the conclusion: such a person does not understand shoemaking (skutiken) or any other craft (technen). Theaetetus confirms (estin houtos).
limits: |
  This is a short illustrative chain embedded in a methodological analogy, not a full elenctic refutation. It demonstrates the form of an assent chain rather than testing a definition.
review_status: accepted
```

```yaml
observation_id: obs_theaetetus_0028
source_work: Theaetetus
stephanus_span: 147a-147b
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
textual_basis: |
  At 147a-147b Socrates lists craftsmen: potters (chutreon), oven-makers (ipnoplathon), brick-makers (plinthourgon), and at 147b figurine-makers (koroplathon) along with "any other craftsmen whatsoever" (allon hostinonoun demiourgon). These examples are framed as low and ready-to-hand (phaulon ti kai procheiron).
limits: |
  The crafts are used as analogical material for a definitional point, not as the subject of inquiry. The passage does not develop a craft-analogy argument about the nature of knowledge but uses humble crafts as examples within a methodological demonstration.
review_status: accepted
```

```yaml
observation_id: obs_theaetetus_0029
temp_id: obs_theaetetus_147c_001
source_work: Theaetetus
...
```yaml
observation_id: obs_theaetetus_0030
temp_id: obs_theaetetus_147c_002
source_work: Theaetetus
stephanus_span: 147c-147d
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0031
temp_id: obs_theaetetus_147c_003
source_work: Theaetetus
stephanus_span: 147c-147d
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0032
source_work: Theaetetus
...
```yaml
observation_id: obs_theaetetus_0033
source_work: Theaetetus
stephanus_span: 145a-145b
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0034
source_work: Theaetetus
stephanus_span: 145a-145b
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0035
source_work: Theaetetus
stephanus_span: 148b-148c
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
  stephanus_span: 148b-148c
  start_marker: 148b
...
```yaml
observation_id: obs_theaetetus_0036
source_work: Theaetetus
stephanus_span: 148b-148c
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0037
source_work: Theaetetus
stephanus_span: 148b-148c
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0038
source_work: Theaetetus
...
source_ref:
  ...
  start_char: 14116
  end_char: 14913
  text_sha256: 9c8fdf71ec85b1d7657534bc580612ad5a63925dcc85058b343739f6ad600cbe
greek_terms:
  - μαιεύεσθαι
  - τέχνην
  - φαρμάκια
...
textual_basis: |
  At 149c Socrates states that human nature is too weak to acquire a techne of matters in which one has no experience, establishing the craft framework. At 149d he enumerates the midwives' powers: they can rouse the birth pangs with drugs and incantations (pharmakia and epadousai), make them gentler, deliver those in difficult labor, cause miscarriage, and are most skilled matchmakers (promnestriai).
limits: |
  The observation records the enumeration of midwifery functions as craft domains; it does not address the maieutic analogy Socrates will later apply to his own philosophical practice.
review_status: accepted
```
...
```yaml
observation_id: obs_theaetetus_0040
source_work: Theaetetus
stephanus_span: 149c-149d
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
textual_basis: |
  At 149c-d Socrates states that midwives, by giving drugs and chanting incantations (epadousai), can rouse birth pangs and make them gentler if they wish.
limits: |
  The observation notes the presence of incantation as an element within a techne description; it does not address whether Socrates' own maieutic practice will include any analogous incantatory element.
review_status: accepted
```

```yaml
observation_id: obs_theaetetus_0041
source_work: Theaetetus
...
```yaml
observation_id: obs_theaetetus_0042
source_work: Theaetetus
stephanus_span: 149a-149b
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0043
source_work: Theaetetus
stephanus_span: 149a-149b
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0044
source_work: Theaetetus
stephanus_span: 147e-148a
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
  stephanus_span: 147e-148a
  start_marker: 147e
...
```yaml
observation_id: obs_theaetetus_0045
source_work: Theaetetus
stephanus_span: 147e-148a
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0047
source_work: Theaetetus
...
```yaml
observation_id: obs_theaetetus_0048
source_work: Theaetetus
stephanus_span: 149e-150a
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0049
source_work: Theaetetus
stephanus_span: 149e-150a
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0050
source_work: Theaetetus
stephanus_span: 148d-148e
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
  stephanus_span: 148d-148e
  start_marker: 148d
...
```yaml
observation_id: obs_theaetetus_0051
source_work: Theaetetus
stephanus_span: 148d-148e
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0052
source_work: Theaetetus
stephanus_span: 148d-148e
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0053
source_work: Theaetetus
...
```yaml
observation_id: obs_theaetetus_0054
source_work: Theaetetus
stephanus_span: 150b-150c
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0055
source_work: Theaetetus
...
source_ref:
  ...
  start_char: 17348
  end_char: 18260
  text_sha256: f20df799aaa85cc86c6d4bfd6ddee420e05427de6cc9cc0f7a8d237bb9d31e09
greek_terms:
  - δαιμόνιον
  - ἀποκωλύει
  - ἐᾷ
...
observation: |
  ...
  those permitted to associate then make progress.
textual_basis: |
  At 151a, Socrates reports that the divine sign that happens to him at
  times blocks association (daimonion apokolyei syneinai) and at times
  permits it (ea), and that those permitted again make progress
  (epididoasi).
limits: |
  The passage does not explain why the daimonion blocks some and permits
  others; it only reports the selective gatekeeping function as a fact
  about Socrates' practice.
review_status: accepted
```

```yaml
observation_id: obs_theaetetus_0056
source_work: Theaetetus
stephanus_span: 151a-151b
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
textual_basis: |
  At 151a-b, Socrates asserts that his techne has the power to rouse this
  labor pain (odina egeirein) and to stop it (apopauein). The clause
  attributes a two-directional capability to the midwifery craft.
limits: |
  The passage does not detail the method by which the techne rouses or
  stops the labor; it only asserts the dual capability as part of the
  midwifery self-description.
review_status: accepted
```

```yaml
observation_id: obs_theaetetus_0057
source_work: Theaetetus
stephanus_span: 151a-151b
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
observation: |
  ...
  need of him, he kindly acts as a procurer and directs them to other
  teachers, naming Prodicus and other wise and divine men as recipients.
textual_basis: |
  At 151b, Socrates says he very kindly acts as a matchmaker
  (promnomai) and reports that he has given many associates to Prodicus
  (Prodikos) and many to other wise and godlike men (sophois te kai
  thespesiois andrasi). The matchmaking is presented as a function
  exercised when the associate shows no signs of intellectual pregnancy.
limits: |
  The observation records the matchmaking claim as an element of the
  midwifery craft description; it does not assess whether Socrates
  actually sent associates to Prodicus, nor does it evaluate the
  characterization of Prodicus as wise or divine.
review_status: accepted
```

```yaml
observation_id: obs_theaetetus_0058
source_work: Theaetetus
...
```yaml
observation_id: obs_theaetetus_0059
source_work: Theaetetus
stephanus_span: 151c-151d
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0060
source_work: Theaetetus
stephanus_span: 151c-151d
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0061
source_work: Theaetetus
...
```yaml
observation_id: obs_theaetetus_0062
source_work: Theaetetus
stephanus_span: 150d-150e
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0063
source_work: Theaetetus
stephanus_span: 150d-150e
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0064
temp_id: obs_theaetetus_seg_001
source_work: Theaetetus
...
```yaml
observation_id: obs_theaetetus_0065
temp_id: obs_theaetetus_seg_002
source_work: Theaetetus
stephanus_span: 152b-152c
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0066
temp_id: obs_theaetetus_seg_003
source_work: Theaetetus
stephanus_span: 152b-152c
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0067
source_work: Theaetetus
...
```yaml
observation_id: obs_theaetetus_0068
source_work: Theaetetus
stephanus_span: 153c-153d
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0069
source_work: Theaetetus
stephanus_span: 153c-153d
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0070
source_work: Theaetetus
...
```yaml
observation_id: obs_theaetetus_0072
source_work: Theaetetus
stephanus_span: 153a-153b
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0073
source_work: Theaetetus
...
```yaml
observation_id: obs_theaetetus_0074
source_work: Theaetetus
stephanus_span: 151e-152a
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0075
source_work: Theaetetus
stephanus_span: 151e-152a
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0076
source_work: Theaetetus
stephanus_span: 155d
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0077
source_work: Theaetetus
stephanus_span: 155d
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0078
source_work: Theaetetus
...
source_ref:
  ...
  start_char: 26669
  end_char: 27594
  text_sha256: 5816eac363db2499f5e854635e4bea0245f2323820bfaccd3379bcf4a2278767
greek_terms:
  - θαυμάζω
  - σκοτοδινιῶ
  - θαυμάζειν
...
```yaml
observation_id: obs_theaetetus_0079
source_work: Theaetetus
...
```yaml
observation_id: obs_theaetetus_0080
source_work: Theaetetus
stephanus_span: 153e-154a
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0081
source_work: Theaetetus
...
textual_basis: |
  The passage describes the eye and a commensurate object approaching and begetting whiteness and perception fused together (156d). Neither perception nor whiteness exists before the encounter; each arises only in the between-space (metaxu, 156e) of the two moving parties.
limits: |
  This is Socrates' exposition of a theory he attributes to others rather than his own, and the passage only models color perception; the generalizing formula at 156e extends the pattern to hard, hot, and everything else but does not prove it.
review_status: rejected
```

```yaml
observation_id: obs_theaetetus_0082
source_work: Theaetetus
stephanus_span: 156d-156e
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
textual_basis: |
  The passage systematically deploys begetting vocabulary: the eye and a commensurate object beget whiteness and perception; the whiteness comes to be from the co-generating (sunapotiktontos) color-source. Socrates also corrects the product's name: the eye becomes not sight but a seeing eye, and the object becomes not whiteness but white (156e).
limits: |
  The observation documents an analogy drawn in the text rather than Socrates' endorsement of the theory. The generative model is part of the Heraclitean-flux doctrine that Theaetetus and Socrates are examining, not a claim Socrates advances in his own voice.
review_status: accepted
```

```yaml
observation_id: obs_theaetetus_0083
source_work: Theaetetus
stephanus_span: 156d-156e
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
textual_basis: |
  Socrates states that the eye became not at all sight but a seeing eye, and the co-generating source became not whiteness in turn but white, whether wood or stone or whatever happened to be colored with such a color (156e).
limits: |
  This describes the internal logic of the flux-perception theory under examination. The feature records how Socrates formulates the theory, not his judgment about its truth. The observation applies only to the naming convention within this specific theoretical exposition.
review_status: accepted
```

```yaml
observation_id: obs_theaetetus_0084
source_work: Theaetetus
...
```yaml
observation_id: obs_theaetetus_0085
source_work: Theaetetus
stephanus_span: 152d-152e
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0086
source_work: Theaetetus
stephanus_span: 152d-152e
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0087
source_work: Theaetetus
...
```yaml
observation_id: obs_theaetetus_0088
source_work: Theaetetus
stephanus_span: 154b-154c
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0089
source_work: Theaetetus
...
```yaml
observation_id: obs_theaetetus_0090
source_work: Theaetetus
stephanus_span: 155e-156a
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0091
source_work: Theaetetus
stephanus_span: 155e-156a
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0092
source_work: Theaetetus
...
source_ref:
  ...
  start_char: 28363
  end_char: 29211
  text_sha256: 1e8f2d5ba93c9aa6cc4df1030715ec2c1b848c80a949a8d3d02500f6f67ba99c
greek_terms:
  - συνεκπίπτουσα
  - γεννωμένη
english_gloss: ""
...
textual_basis: |
  At 156b the text describes the two as twins, one the sensible and the other sensation, always coinciding and being generated together with the sensible (156b). The twin metaphor and vocabulary of generation locate this perceptual account in a flux-based ontology introduced earlier in the dialogue.
limits: |
  The observation records the twin-generation formula for perception and sensible. It does not assess whether the account is endorsed by Socrates or refuted later in the dialogue.
review_status: accepted
```

```yaml
observation_id: obs_theaetetus_0093
source_work: Theaetetus
stephanus_span: 156b-156c
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
textual_basis: |
  The self-label mythos at 156c appears at a transition where Socrates pauses the narrative exposition and questions Theaetetus about its bearing on earlier arguments. The demonstrative "this mythos" refers back to the twin-generation ontology just elaborated, marking the boundary between mythic exposition and dialectical interrogation.
limits: |
  The observation notes the mythos self-label at 156c. It does not decide whether the label undermines, endorses, or merely hedges the flux-based perceptual account. The relationship between this mythos and the earlier Protagorean or Heraclitean doctrines is not assessed.
review_status: accepted
```
...
```yaml
observation_id: obs_theaetetus_0095
source_work: Theaetetus
...
```yaml
observation_id: obs_theaetetus_0096
source_work: Theaetetus
stephanus_span: 157a-157b
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
  stephanus_span: 157a-157b
  start_marker: 157a
  ...
  start_char: 29989
  end_char: 30939
  text_sha256: 4a1400918b5ee4cf7607042d671c502df5ba356c48969ac278ee79142c445f98
greek_terms:
  - αὑτὸ μηδὲν εἶναι
  - οὐδὲν εἶναι ἓν αὐτὸ καθ’ αὑτό
  - τινι ἀεὶ γίγνεσθαι
...
textual_basis: |
  At 157a-b Socrates recapitulates the doctrine that nothing has stable self-identity. The phrases "nothing is one thing itself by itself" (ouden einai hen auto kath' hauto) and "always comes to be for something" (tini aei gignesthai) are direct denials of self-subsistent being. The sentence "being must be removed from everywhere" (to d' einai pantachothen exaireteon) marks the exclusion of stable being from the ontology under discussion.
limits: |
  The observation notes Socrates' restatement of a position, not his endorsement. The passage does not assert the existence of self-subsistent forms; it reports a doctrine that denies them. The observation does not claim that the Theaetetus as a whole rejects this doctrine.
review_status: accepted
```

```yaml
observation_id: obs_theaetetus_0097
source_work: Theaetetus
stephanus_span: 157a-157b
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
textual_basis: |
  At 157b Socrates reports a procedural rule from the wise men's doctrine: do not concede stabilizing words, but speak in process-terms. The contrast between stabilising speech (histēi, stēsēi) and speaking by nature in process terms is a dichotomy between two modes of description. Using a stabilising term makes the speaker "easy to refute" (euelenktos).
limits: |
  This observation records a stated methodological rule, not its validity. The passage does not specify who the refuter is or what the refutation consists in. The constraint on language is presented as part of the wise men's doctrine, not necessarily Socrates' own view.
review_status: accepted
```

```yaml
observation_id: obs_theaetetus_0098
source_work: Theaetetus
stephanus_span: 157a-157b
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
textual_basis: |
  At 157b Socrates says: "not that we have just now been compelled by habit and ignorance to use it" (ouch hoti hēmeis polla kai arti ēnankasmetha hupo sunētheias kai anepistēmosunēs chrēsthai autōi). The clause follows the injunction to remove "being" and explains why the term is still used. The appeal to custom and ignorance shifts responsibility for inconsistency from the speaker to epistemically blemished linguistic practice.
limits: |
  This observation does not claim Socrates endorses the wise men's doctrine. The hedge may be genuine or ironic; the text does not settle which. The "we" includes the speaker and possibly the interlocutors, not necessarily Socrates alone.
review_status: accepted
```

```yaml
observation_id: obs_theaetetus_0099
source_work: Theaetetus
...
```yaml
observation_id: obs_theaetetus_0100
source_work: Theaetetus
stephanus_span: 157e-158a
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0101
source_work: Theaetetus
stephanus_span: 157e-158a
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0102
source_work: Theaetetus
...
```yaml
observation_id: obs_theaetetus_0103
source_work: Theaetetus
stephanus_span: 157c-157d
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0104
source_work: Theaetetus
stephanus_span: 157c-157d
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0105
source_work: Theaetetus
...
```yaml
observation_id: obs_theaetetus_0106
source_work: Theaetetus
stephanus_span: 154d-154e
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0107
source_work: Theaetetus
stephanus_span: 154d-154e
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0108
source_work: Theaetetus
...
```yaml
observation_id: obs_theaetetus_0109
source_work: Theaetetus
stephanus_span: 158d-158e
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0110
source_work: Theaetetus
stephanus_span: 158d-158e
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0111
source_work: Theaetetus
...
greek_terms:
  - γλυκύτητά τε καὶ αἴσθησιν
  - γλυκὺν τὸν οἶνον τῇ ὑγιαινούσῃ γλώττῃ ἐποίησεν καὶ εἶναι καὶ φαίνεσθαι
  - γεννήσομεν
  - ἐγέννησε
...
```yaml
observation_id: obs_theaetetus_0112
source_work: Theaetetus
stephanus_span: 159c-159d
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0113
source_work: Theaetetus
...
```yaml
observation_id: obs_theaetetus_0114
source_work: Theaetetus
stephanus_span: 159a-159b
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0115
source_work: Theaetetus
stephanus_span: 159a-159b
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0116
source_work: Theaetetus
...
```yaml
observation_id: obs_theaetetus_0117
source_work: Theaetetus
stephanus_span: 160b-160c
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0118
source_work: Theaetetus
stephanus_span: 160b-160c
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0119
source_work: Theaetetus
...
```yaml
observation_id: obs_theaetetus_0120
source_work: Theaetetus
stephanus_span: 160d-160e
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0121
source_work: Theaetetus
stephanus_span: 160d-160e
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0122
source_work: Theaetetus
...
```yaml
observation_id: obs_theaetetus_0123
source_work: Theaetetus
stephanus_span: 161c-161d
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0124
source_work: Theaetetus
...
```yaml
observation_id: obs_theaetetus_0126
source_work: Theaetetus
stephanus_span: 159e-160a
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0127
source_work: Theaetetus
...
```yaml
observation_id: obs_theaetetus_0128
source_work: Theaetetus
stephanus_span: 158b-158c
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0129
source_work: Theaetetus
...
source_ref:
  ...
  start_char: 43832
  end_char: 44602
  text_sha256: 94b76e75fc209e89ff8f296f7c15552e243294da0f49caf71a07e3339caa04c6
greek_terms:
...
```yaml
observation_id: obs_theaetetus_0130
source_work: Theaetetus
stephanus_span: 163c-163d
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0131
source_work: Theaetetus
stephanus_span: 163c-163d
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0132
source_work: Theaetetus
...
```yaml
observation_id: obs_theaetetus_0133
source_work: Theaetetus
stephanus_span: 163e-164a
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0134
source_work: Theaetetus
stephanus_span: 163e-164a
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0135
source_work: Theaetetus
...
```yaml
observation_id: obs_theaetetus_0136
source_work: Theaetetus
stephanus_span: 162b-162c
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0137
source_work: Theaetetus
stephanus_span: 162b-162c
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0138
source_work: Theaetetus
...
```yaml
observation_id: obs_theaetetus_0139
source_work: Theaetetus
stephanus_span: 161e-162a
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0140
source_work: Theaetetus
stephanus_span: 161e-162a
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0141
source_work: Theaetetus
...
```yaml
observation_id: obs_theaetetus_0142
source_work: Theaetetus
stephanus_span: 164b-164c
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0143
source_work: Theaetetus
stephanus_span: 164b-164c
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0144
source_work: Theaetetus
...
```yaml
observation_id: obs_theaetetus_0145
source_work: Theaetetus
stephanus_span: 162d-162e
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0146
source_work: Theaetetus
...
```yaml
observation_id: obs_theaetetus_0147
source_work: Theaetetus
stephanus_span: 164d-164e
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0148
source_work: Theaetetus
stephanus_span: 164d-164e
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0149
source_work: Theaetetus
...
source_ref:
  ...
  start_char: 49560
  end_char: 50484
  text_sha256: 439e57a5fefdabbabe8fad8e04b69bc709a958d3b5fbf10fdbecd841db454f53
greek_terms:
  - ὗς
  - κυνοκεφάλους
  - ὑηνεῖς
...
```yaml
observation_id: obs_theaetetus_0150
source_work: Theaetetus
stephanus_span: 166b-166c
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0151
source_work: Theaetetus
stephanus_span: 166b-166c
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0152
source_work: Theaetetus
...
textual_basis: |
  At 167a the text states that just as the doctor changes a patient by drugs (pharmakois), the sophist changes by logoi, and in each domain (body for the doctor, soul for the sophist) the change is from one hexis to a better one (ameino). The analogy is sustained through the parallel syntax and the shared verb metaballein.
limits: |
  The observation records a craft-to-sophistry analogy; it does not claim that Plato endorses the analogy. The speaker here is not Socrates but the defender of Protagoras's position.
review_status: accepted
```

```yaml
observation_id: obs_theaetetus_0153
source_work: Theaetetus
stephanus_span: 167a-167b
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0154
source_work: Theaetetus
stephanus_span: 167a-167b
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0155
source_work: Theaetetus
stephanus_span: 164e-165a
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
  stephanus_span: 164e-165a
  start_marker: 164e
...
```yaml
observation_id: obs_theaetetus_0156
source_work: Theaetetus
...
```yaml
observation_id: obs_theaetetus_0157
source_work: Theaetetus
stephanus_span: 165a-165b
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0158
source_work: Theaetetus
...
```yaml
observation_id: obs_theaetetus_0161
source_work: Theaetetus
...
```yaml
observation_id: obs_theaetetus_0162
source_work: Theaetetus
...
```yaml
observation_id: obs_theaetetus_0164
source_work: Theaetetus
...
```yaml
observation_id: obs_theaetetus_0165
source_work: Theaetetus
stephanus_span: 165c-165d
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0166
source_work: Theaetetus
stephanus_span: 165c-165d
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0167
source_work: Theaetetus
...
```yaml
observation_id: obs_theaetetus_0168
source_work: Theaetetus
stephanus_span: 168b-168c
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0169
source_work: Theaetetus
stephanus_span: 168b-168c
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0170
source_work: Theaetetus
...
source_ref:
  ...
  start_char: 54601
  end_char: 55371
  text_sha256: 1338d74aa76078e93193733060e29289c182f1bed1b3e9c13b53ff7a7c4e747d
greek_terms:
  - παιδία
  - σπουδάσαι
  - παίζοντες
...
```yaml
observation_id: obs_theaetetus_0171
source_work: Theaetetus
stephanus_span: 168d-168e
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0172
source_work: Theaetetus
stephanus_span: 168d-168e
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0173
source_work: Theaetetus
stephanus_span: 169c-169d
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
  stephanus_span: 169c-169d
  start_marker: 169c
...
```yaml
observation_id: obs_theaetetus_0174
source_work: Theaetetus
stephanus_span: 169c-169d
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0175
source_work: Theaetetus
stephanus_span: 169c-169d
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0176
source_work: Theaetetus
...
```yaml
observation_id: obs_theaetetus_0177
source_work: Theaetetus
stephanus_span: 169e-170a
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0178
source_work: Theaetetus
stephanus_span: 169e-170a
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0179
source_work: Theaetetus
stephanus_span: 169a-169b
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
  stephanus_span: 169a-169b
  start_marker: 169a
  ...
  start_char: 55371
  end_char: 56282
  text_sha256: 58dbb0eb696efca6a896c8ab40dd285e357fc85c355f5eae8ec3929e0ad58bbc
greek_terms:
  - Σκίρωνα
  - Ἀνταῖόν
  - Ἡρακλέες
...
textual_basis: |
  At 169a-b, Theodorus says Socrates seems to incline more toward Sciron and acts like Antaeus, not letting anyone go until they strip and wrestle in words. Socrates responds at 169b that countless Heracleses and Theseuses strong in speaking have beaten him, but he does not give up. The mythological figures are used to characterize Socratic dialectical practice.
limits: |
  Does not claim that Socrates is equated with Sciron/Antaeus in all respects, nor that the mythological comparison is a mythic narrative in itself. The observation only notes the use of mythic exempla within an argument about dialectical procedure.
review_status: accepted
```

```yaml
observation_id: obs_theaetetus_0180
source_work: Theaetetus
stephanus_span: 169a-169b
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
textual_basis: |
  At 169a, Theodorus complains that Socrates will not let him off without stripping and forces him to strip and wrestle in words, contrasting this with Spartan practice. Socrates at 169b accepts the characterization, calling it a fine likeness of his disease and claiming superior vigor. The athletic domain of wrestling, with its stripping, grappling, and persistence, is systematically mapped onto dialectical argument.
limits: |
  Does not claim that dialectic literally is wrestling, nor that the metaphor is developed beyond this passage. The observation notes the mapping of athletic combat vocabulary onto the activity of verbal exchange.
review_status: accepted
```

```yaml
observation_id: obs_theaetetus_0181
source_work: Theaetetus
...
```yaml
observation_id: obs_theaetetus_0182
source_work: Theaetetus
stephanus_span: 170d-170e
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0183
source_work: Theaetetus
...
```yaml
observation_id: obs_theaetetus_0184
source_work: Theaetetus
stephanus_span: 171a-171b
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0185
source_work: Theaetetus
...
source_ref:
  ...
  start_char: 60540
  end_char: 61428
  text_sha256: ae7c5c25d0dea2690c3ae5d6b1ead628266ba42985061ae57bad71d2ccfb38bc
greek_terms:
  - καταθέομεν
  - παραθέομεν
english_gloss: ""
...
```yaml
observation_id: obs_theaetetus_0186
source_work: Theaetetus
stephanus_span: 171c-171d
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0187
source_work: Theaetetus
stephanus_span: 171c-171d
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0188
source_work: Theaetetus
...
```yaml
observation_id: obs_theaetetus_0189
source_work: Theaetetus
stephanus_span: 173c-173d
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0190
source_work: Theaetetus
stephanus_span: 173c-173d
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0191
source_work: Theaetetus
...
```yaml
observation_id: obs_theaetetus_0193
source_work: Theaetetus
stephanus_span: 173e-174a
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0194
source_work: Theaetetus
...
```yaml
observation_id: obs_theaetetus_0195
source_work: Theaetetus
stephanus_span: 174b-174c
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0196
source_work: Theaetetus
...
```yaml
observation_id: obs_theaetetus_0197
source_work: Theaetetus
stephanus_span: 175c-175d
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0198
source_work: Theaetetus
stephanus_span: 175c-175d
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0199
source_work: Theaetetus
...
```yaml
observation_id: obs_theaetetus_0200
source_work: Theaetetus
stephanus_span: 174d-174e
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0201
source_work: Theaetetus
...
```yaml
observation_id: obs_theaetetus_0202
source_work: Theaetetus
stephanus_span: 176b-176c
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0203
source_work: Theaetetus
...
source_ref:
  ...
  start_char: 68214
  end_char: 69040
  text_sha256: 2b8dacb6374c9356adc334d44f11099f1c9788527d9cb485faf147099563a27f
greek_terms:
  - ἀπαιδευσίας
...
```yaml
observation_id: obs_theaetetus_0204
source_work: Theaetetus
stephanus_span: 175a-175b
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0205
source_work: Theaetetus
stephanus_span: 175a-175b
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0206
source_work: Theaetetus
...
```yaml
observation_id: obs_theaetetus_0208
source_work: Theaetetus
stephanus_span: 177a-177b
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
  stephanus_span: 177a-177b
  start_marker: 177a
  ...
  start_char: 72236
  end_char: 73132
  text_sha256: ea4de43bcd31766c8e56039de3d2447aa2aefb9b0e4817f0f24f21add1d2d90d
greek_terms:
...
```yaml
observation_id: obs_theaetetus_0209
source_work: Theaetetus
stephanus_span: 177e-178a
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
  stephanus_span: 177e-178a
  start_marker: 177e
...
textual_basis: |
  At 177e Socrates says "let him not say the name, but let him contemplate the thing named" (me gar legeto to onoma, alla to pragma to onomazomenon theoreito). At 178a he expands by reference to "the whole eidos in which the beneficial happens to be" (peri pantos tou eidous en ho kai to ophelimon tunchanei on) and specifies the future (ton mellonta chronon) as the temporal domain of legislation.
limits: |
  This observation does not claim that a full definition of the beneficial is given; only that a methodological move from name to thing and from particular to eidos with temporal specification is demonstrated.
review_status: accepted
```

```yaml
observation_id: obs_theaetetus_0210
source_work: Theaetetus
stephanus_span: 177e-178a
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
textual_basis: |
  Theodorus's responses form a chain: "me gar" (177e, affirming Socrates's directive), "oudamos" (178a, denying any other aim of legislation), "oimai egoge kai hamartanein" (178a, conceding cities do err). These successive assents enable Socrates to introduce the broader eidos-based inquiry.
limits: |
  This record does not claim the assent chain produces a contradiction or aporia; it only identifies the sequential yes-responses that structure the argumentative passage.
review_status: accepted
```

```yaml
observation_id: obs_theaetetus_0211
source_work: Theaetetus
stephanus_span: 177e-178a
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
textual_basis: |
  At 177e Socrates says legislation "aims at this" (toutou depou stochazetai nomothetoumene) and sets laws "as most beneficial to itself" (hos ophelimotatous heaute tithetai). At 178a Theodorus concedes cities often miss (polla kai diamartanei). The passage uses stochazetai (aims at) and diamartanei (misses, errs), vocabulary that aligns legislation with a goal-oriented technē.
limits: |
  This observation does not claim that legislation is a technē in the full Socratic sense, only that the passage deploys craft-analogical vocabulary of aiming and error for the legislative activity.
review_status: rejected
```

```yaml
observation_id: obs_theaetetus_0212
source_work: Theaetetus
...
```yaml
observation_id: obs_theaetetus_0213
source_work: Theaetetus
stephanus_span: 177c-177d
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0214
source_work: Theaetetus
...
```yaml
observation_id: obs_theaetetus_0215
source_work: Theaetetus
stephanus_span: 178d-178e
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0216
source_work: Theaetetus
stephanus_span: 178d-178e
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0217
source_work: Theaetetus
...
```yaml
observation_id: obs_theaetetus_0218
source_work: Theaetetus
stephanus_span: 175e-176a
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0220
source_work: Theaetetus
...
```yaml
observation_id: obs_theaetetus_0221
source_work: Theaetetus
stephanus_span: 179e-180a
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0222
source_work: Theaetetus
...
textual_basis: |
  At 178b Socrates restates Protagoras' thesis that a person possesses the criterion (kriterion) within himself such that whatever he experiences, he believes truly for himself. At 178c Socrates asks whether this also applies to future events, posing the fever case in which a layperson (idiotes) and a doctor (iatros) hold opposing beliefs about the same man's future condition. Theodorus responds that the consequence would be ridiculous (geloion), signaling the counterexample's force against the doctrine.
limits: |
  The observation records that a counterexample is introduced and that an interlocutor labels its consequence ridiculous. It does not claim that a formal refutation is completed within this span, nor does it assess whether the counterexample is logically sound.
review_status: accepted
```

```yaml
observation_id: obs_theaetetus_0223
source_work: Theaetetus
stephanus_span: 178b-178c
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
textual_basis: |
  The Greek text at 178c explicitly contrasts the layperson (idiotes) who believes he will get a fever with the doctor (iatros) who holds the opposite belief. Socrates asks whose belief should determine what the future holds, thereby introducing expert judgment as a test for the universal scope of Protagoras' measure doctrine.
limits: |
  This observation records the textual deployment of expert-vs.-layperson contrast as an elenctic test. It does not claim that the doctor's expertise is definitively vindicated within this span or that the test is completed here.
review_status: accepted
```

```yaml
observation_id: obs_theaetetus_0224
source_work: Theaetetus
stephanus_span: 178b-178c
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
textual_basis: |
  Socrates at 178c explicitly frames the test with a conditional and interrogative structure, asking whether one who believes something about the future (to mellon) also has the criterion within himself. The fever scenario is introduced with ara and a specific concrete illustration involving two agents with opposing doxai about the same future event.
limits: |
  The observation identifies the deployment of a hypothetical scenario as a turn-geometry device. It does not assess whether the scenario successfully refutes the doctrine, nor does it claim originality of the device.
review_status: accepted
```

```yaml
observation_id: obs_theaetetus_0225
source_work: Theaetetus
...
```yaml
observation_id: obs_theaetetus_0226
source_work: Theaetetus
...
source_ref:
  ...
  start_char: 76341
  end_char: 77198
  text_sha256: a00b5c862330ec8accdf4a26d1fd7ff601aca8db9cd554d8d2f984d7e329139e
greek_terms:
  - ἁλίσκεσθαι
  - ἁλισκόμενος
english_gloss: ""
...
```yaml
observation_id: obs_theaetetus_0227
source_work: Theaetetus
stephanus_span: 179a-179b
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0228
source_work: Theaetetus
...
```yaml
observation_id: obs_theaetetus_0229
source_work: Theaetetus
stephanus_span: 181c-181d
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0230
source_work: Theaetetus
stephanus_span: 181c-181d
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0231
source_work: Theaetetus
...
```yaml
observation_id: obs_theaetetus_0232
source_work: Theaetetus
stephanus_span: 182b-182c
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0233
source_work: Theaetetus
stephanus_span: 182b-182c
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0234
source_work: Theaetetus
...
```yaml
observation_id: obs_theaetetus_0235
source_work: Theaetetus
stephanus_span: 182d-182e
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0236
source_work: Theaetetus
...
```yaml
observation_id: obs_theaetetus_0237
source_work: Theaetetus
stephanus_span: 179c-179d
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0238
source_work: Theaetetus
stephanus_span: 179c-179d
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0239
source_work: Theaetetus
...
```yaml
observation_id: obs_theaetetus_0241
source_work: Theaetetus
...
```yaml
observation_id: obs_theaetetus_0242
source_work: Theaetetus
stephanus_span: 183c-183d
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0243
source_work: Theaetetus
stephanus_span: 183c-183d
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0244
source_work: Theaetetus
...
```yaml
observation_id: obs_theaetetus_0245
source_work: Theaetetus
stephanus_span: 183e-184a
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0246
source_work: Theaetetus
stephanus_span: 183e-184a
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0247
source_work: Theaetetus
...
```yaml
observation_id: obs_theaetetus_0248
source_work: Theaetetus
stephanus_span: 180b-180c
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0249
source_work: Theaetetus
stephanus_span: 180b-180c
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0250
source_work: Theaetetus
...
```yaml
observation_id: obs_theaetetus_0251
source_work: Theaetetus
stephanus_span: 184b-184c
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0252
source_work: Theaetetus
stephanus_span: 184b-184c
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0253
source_work: Theaetetus
...
```yaml
observation_id: obs_theaetetus_0254
source_work: Theaetetus
stephanus_span: 181e-182a
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0255
source_work: Theaetetus
stephanus_span: 181e-182a
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0256
source_work: Theaetetus
...
```yaml
observation_id: obs_theaetetus_0257
source_work: Theaetetus
stephanus_span: 185c-185d
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0258
source_work: Theaetetus
stephanus_span: 185c-185d
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0259
source_work: Theaetetus
...
```yaml
observation_id: obs_theaetetus_0262
source_work: Theaetetus
...
```yaml
observation_id: obs_theaetetus_0263
source_work: Theaetetus
stephanus_span: 185e-186a
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0264
source_work: Theaetetus
stephanus_span: 185e-186a
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0265
source_work: Theaetetus
...
source_ref:
  ...
  start_char: 88184
  end_char: 88965
  text_sha256: d35dc898f861a209a96144d5721c9a7a4380e168264a2478e91d1a223fd54346
greek_terms:
  - ἰδέαν
  - ὀργάνων
  - αἰσθανόμεθα
...
```yaml
observation_id: obs_theaetetus_0266
source_work: Theaetetus
stephanus_span: 184d-184e
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0267
source_work: Theaetetus
stephanus_span: 184d-184e
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0268
source_work: Theaetetus
...
```yaml
observation_id: obs_theaetetus_0269
source_work: Theaetetus
stephanus_span: 186d-186e
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0270
source_work: Theaetetus
stephanus_span: 186d-186e
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0271
source_work: Theaetetus
...
```yaml
observation_id: obs_theaetetus_0272
source_work: Theaetetus
stephanus_span: 186b-186c
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0273
source_work: Theaetetus
...
```yaml
observation_id: obs_theaetetus_0274
source_work: Theaetetus
stephanus_span: 188b-188c
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0275
source_work: Theaetetus
...
```yaml
observation_id: obs_theaetetus_0276
source_work: Theaetetus
stephanus_span: 187c-187d
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0277
source_work: Theaetetus
stephanus_span: 187c-187d
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0278
source_work: Theaetetus
...
```yaml
observation_id: obs_theaetetus_0279
source_work: Theaetetus
stephanus_span: 187e-188a
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0280
source_work: Theaetetus
stephanus_span: 187e-188a
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0281
source_work: Theaetetus
...
source_ref:
  ...
  start_char: 96464
  end_char: 97275
  text_sha256: 1085f5bb5f43ee6ef02f7b5987966a883360795569ad409ecfbaf2515c5f4991
greek_terms:
  - τὰ μὴ ὄντα
  - μὴ ἀληθῆ
english_gloss: ""
...
```yaml
observation_id: obs_theaetetus_0282
source_work: Theaetetus
stephanus_span: 188d-188e
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0283
source_work: Theaetetus
stephanus_span: 188d-188e
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0284
source_work: Theaetetus
...
source_ref:
  ...
  start_char: 97275
  end_char: 98096
  text_sha256: 738a110a42042d626236efea2b97fbc45636371590a1cc02090c2cc632f6c70e
greek_terms:
  - ἀκούων
  - ἁπτόμενος
  - δοξάζων
...
```yaml
observation_id: obs_theaetetus_0285
source_work: Theaetetus
stephanus_span: 189a-189b
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0286
source_work: Theaetetus
stephanus_span: 189a-189b
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
textual_basis: |
  At 191c Socrates proposes the wax block as an image (using kērinon ekmageion, waxen tablet), and at 191d he describes how it receives imprints from sense-perceptions and thoughts, likening the process to seal-rings leaving marks. The passage presents a sustained craft analogy: a material (wax) whose properties determine the quality and durability of recorded impressions.
limits: |
  The analogy is used to explain memory and the capacity to learn what one did not previously know; it does not itself prove that the soul has such a wax block. The observation records the introduction of the analogy, not its later testing against false judgment.
review_status: accepted
```
...
textual_basis: |
  At 191d Socrates says that the wax block is a gift of Mnemosyne, mother of the Muses. He uses the formula "let us say..." (phōmen), presenting the divine attribution as a framing device for the cognitive model. This names a specific mythological figure and assigns the wax block to her as a gift, embedding the analogy in a mythic frame before the epistemological argument proceeds.
limits: |
  The observation identifies a mythic framing within an argumentative passage; it does not claim that the whole theory of judgment depends on this myth. The divine reference is brief and does not introduce a full narrative.
review_status: accepted
```
...
textual_basis: |
  At 191c Socrates says we are held in such a position that every argument must be turned around and tested (basanizein). This frames the following analogy as a testing device, explicitly marking the introduction of a new argumentative procedure. The wax block is then introduced with "set it down for me for the sake of argument," a procedural formula.
limits: |
  This observation records the procedural framing of the passage, not the content of the wax analogy or the mythic reference. The procedural framing is a distinct feature from the analogy itself.
review_status: accepted
```

```yaml
observation_id: obs_theaetetus_0290
source_work: Theaetetus
...
```yaml
observation_id: obs_theaetetus_0291
source_work: Theaetetus
...
observation: |
  ...
  and answering itself, affirming and denying. He then defines doxa as that
  internal logos when the soul settles on something and no longer doubts,
  calling it "a logos spoken, not to another nor aloud, but silently to
  oneself."
textual_basis: |
  At 189e-190a Socrates states: "the soul goes through a logos with itself
  about whatever it examines" and "thinking appears to me to be nothing other
  than conversing, itself asking and answering itself, affirming and denying."
  He then adds: "when having determined...it now says the same thing and does
  not waver, we posit this as its opinion. So I call opining speaking, and
  opinion a logos spoken, not to another nor aloud, but silently to oneself."
  Theaetetus agrees at 190a.
limits: |
  The passage defines doxa in terms of an internal process; it does not address
  whether this account of opinion is sufficient for knowledge or for
  distinguishing true from false opinion. Socrates presents this as his own
  impression (indalletai), not a necessary conclusion.
review_status: accepted
```

```yaml
observation_id: obs_theaetetus_0292
source_work: Theaetetus
stephanus_span: 189e-190a
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
observation: |
  ...
  (hōs ge mē eidōs soi apophainomai).
textual_basis: |
  At 189e, immediately after offering the definition of thinking as the soul's
  internal logos, Socrates inserts "hōs ge mē eidōs soi apophainomai" (I am
  telling you this as one who does not know). This is a standard Socratic
  knowledge disavowal embedded within a positive definitional proposal.
limits: |
  The disavowal hedges the definition that follows but does not retract it;
  Socrates presents his account of dianoia and doxa as his impression
  (indalletai) rather than as demonstrated knowledge. The passage does not
  indicate whether this disavowal is genuine or tactical.
review_status: accepted
```

```yaml
observation_id: obs_theaetetus_0293
source_work: Theaetetus
...
```yaml
observation_id: obs_theaetetus_0294
source_work: Theaetetus
...
```yaml
observation_id: obs_theaetetus_0295
source_work: Theaetetus
stephanus_span: 190d-190e
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0297
source_work: Theaetetus
...
```yaml
observation_id: obs_theaetetus_0298
source_work: Theaetetus
stephanus_span: 191a-191b
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0299
source_work: Theaetetus
...
```yaml
observation_id: obs_theaetetus_0300
source_work: Theaetetus
...
```yaml
observation_id: obs_theaetetus_0301
source_work: Theaetetus
stephanus_span: 193c-193d
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0302
source_work: Theaetetus
stephanus_span: 193c-193d
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0303
source_work: Theaetetus
...
```yaml
observation_id: obs_theaetetus_0304
source_work: Theaetetus
stephanus_span: 192d-192e
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0305
source_work: Theaetetus
stephanus_span: 192d-192e
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0306
source_work: Theaetetus
...
```yaml
observation_id: obs_theaetetus_0307
source_work: Theaetetus
stephanus_span: 187a-187b
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0308
source_work: Theaetetus
stephanus_span: 187a-187b
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0309
source_work: Theaetetus
...
```yaml
observation_id: obs_theaetetus_0310
source_work: Theaetetus
stephanus_span: 195c-195d
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0311
source_work: Theaetetus
...
```yaml
observation_id: obs_theaetetus_0312
source_work: Theaetetus
...
```yaml
observation_id: obs_theaetetus_0313
source_work: Theaetetus
stephanus_span: 195e-196a
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0314
source_work: Theaetetus
stephanus_span: 195e-196a
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0315
source_work: Theaetetus
stephanus_span: 166d
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
  ...
  start_char: 50484
  end_char: 50921
  text_sha256: f3f561ce0528462489fc0de8e123f5bd35e26c4125b2b3ac651548af413a2913
greek_terms:
  - μέτρον
  - σοφίαν
  - σοφὸν ἄνδρα
...
```yaml
observation_id: obs_theaetetus_0316
source_work: Theaetetus
stephanus_span: 166e
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
  ...
  start_char: 50921
  end_char: 51172
  text_sha256: 71cee1cd7e692c1ab74353e5dc83b331c663f11a97c399e55993e5ae282e76c5
greek_terms:
  - ἀσθενοῦντι
  - πικρὰ
  - ὑγιαίνοντι
...
```yaml
observation_id: obs_theaetetus_0317
source_work: Theaetetus
stephanus_span: 170b
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0318
source_work: Theaetetus
stephanus_span: 170c
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0319
source_work: Theaetetus
stephanus_span: 172b
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0320
source_work: Theaetetus
stephanus_span: 172c
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
  ...
  start_char: 62756
  end_char: 63147
  text_sha256: 9ed2ce9a42ce5f29c4fa6d3a58885fbff6859647baee02d85ec9b068625aaeae
greek_terms:
  - σχολὴν
  - δικαστήρια
  - γελοῖοι
...
```yaml
observation_id: obs_theaetetus_0321
source_work: Theaetetus
stephanus_span: 172d
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
  ...
  start_char: 63147
  end_char: 63561
  text_sha256: 521d9997e97d3e18a7d783f741529eb11334196dd6fc3e0f3e425ee23ed7bd90
greek_terms:
  - σχολή
  - εἰρήνῃ
  - τρίτον
...
```yaml
observation_id: obs_theaetetus_0322
source_work: Theaetetus
stephanus_span: 172e
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
  ...
  start_char: 63561
  end_char: 63970
  text_sha256: 8d437acd439bf06cdd85afa2ebc17f8b9c1fec0b31d82e4d49539f6adc7a1487
greek_terms:
  - ὕδωρ ῥέον
  - ἀνάγκην
  - ἀντίδικος
...
```yaml
observation_id: obs_theaetetus_0323
source_work: Theaetetus
stephanus_span: 173a
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0324
source_work: Theaetetus
stephanus_span: 173b
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
  ...
  start_char: 64426
  end_char: 64853
  text_sha256: 4eae0b8fa9264e51759bc4d49c1dc590968e2963f730a2b18119c8cc2fb640a4
greek_terms:
  - ἡμετέρου χοροῦ
  - πάλιν ἐπὶ τὸν λόγον
  - ἐλευθερίᾳ
...
```yaml
observation_id: obs_theaetetus_0326
source_work: Theaetetus
stephanus_span: 189d
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0327
source_work: Theaetetus
stephanus_span: 193a
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0328
source_work: Theaetetus
stephanus_span: 193b
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0329
source_work: Theaetetus
stephanus_span: 193e
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0331
source_work: Theaetetus
stephanus_span: 194d
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0332
source_work: Theaetetus
stephanus_span: 194e
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0333
source_work: Theaetetus
stephanus_span: 195a
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0334
source_work: Theaetetus
stephanus_span: 195b
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0335
source_work: Theaetetus
stephanus_span: 196d
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0336
source_work: Theaetetus
stephanus_span: 196e
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0337
source_work: Theaetetus
stephanus_span: 197a
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0338
source_work: Theaetetus
stephanus_span: 197b
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0339
source_work: Theaetetus
stephanus_span: 197c
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0341
source_work: Theaetetus
stephanus_span: 197e
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0342
source_work: Theaetetus
stephanus_span: 198a
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0344
source_work: Theaetetus
stephanus_span: 198c
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0345
source_work: Theaetetus
stephanus_span: 198d
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0346
source_work: Theaetetus
stephanus_span: 198e
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0348
source_work: Theaetetus
stephanus_span: 199b
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0406
source_work: Theaetetus
stephanus_span: 199c
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0350
source_work: Theaetetus
stephanus_span: 199d
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0351
source_work: Theaetetus
stephanus_span: 199e
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0352
source_work: Theaetetus
stephanus_span: 200a
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0356
source_work: Theaetetus
stephanus_span: 200e
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0357
source_work: Theaetetus
stephanus_span: 201a
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0358
source_work: Theaetetus
stephanus_span: 201b
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0359
source_work: Theaetetus
stephanus_span: 201c
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0361
source_work: Theaetetus
stephanus_span: 201e
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0362
source_work: Theaetetus
stephanus_span: 202a
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0363
source_work: Theaetetus
stephanus_span: 202b
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0366
source_work: Theaetetus
stephanus_span: 202e
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0367
source_work: Theaetetus
stephanus_span: 203a
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0368
source_work: Theaetetus
stephanus_span: 203b
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0369
source_work: Theaetetus
stephanus_span: 203c
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0370
source_work: Theaetetus
stephanus_span: 203d
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0371
source_work: Theaetetus
stephanus_span: 203e
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0372
source_work: Theaetetus
stephanus_span: 204a
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0373
source_work: Theaetetus
stephanus_span: 204b
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0374
source_work: Theaetetus
stephanus_span: 204c
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0375
source_work: Theaetetus
stephanus_span: 204d
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0376
source_work: Theaetetus
stephanus_span: 204e
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0377
source_work: Theaetetus
stephanus_span: 205a
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0378
source_work: Theaetetus
stephanus_span: 205b
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0379
source_work: Theaetetus
stephanus_span: 205c
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0381
source_work: Theaetetus
stephanus_span: 205e
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0382
source_work: Theaetetus
stephanus_span: 206a
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0383
source_work: Theaetetus
stephanus_span: 206b
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0384
source_work: Theaetetus
stephanus_span: 206c
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0385
source_work: Theaetetus
stephanus_span: 206d
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0386
source_work: Theaetetus
stephanus_span: 206e
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0388
source_work: Theaetetus
stephanus_span: 207b
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0390
source_work: Theaetetus
stephanus_span: 207d
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0391
source_work: Theaetetus
stephanus_span: 207e
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0392
source_work: Theaetetus
stephanus_span: 208a
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0393
source_work: Theaetetus
stephanus_span: 208b
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0394
source_work: Theaetetus
stephanus_span: 208c
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0395
source_work: Theaetetus
stephanus_span: 208d
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0396
source_work: Theaetetus
stephanus_span: 208e
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0397
source_work: Theaetetus
stephanus_span: 209a
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0398
source_work: Theaetetus
stephanus_span: 209b
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0399
source_work: Theaetetus
stephanus_span: 209c
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0400
source_work: Theaetetus
stephanus_span: 209d
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0401
source_work: Theaetetus
stephanus_span: 209e
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0403
source_work: Theaetetus
stephanus_span: 210b
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0407
source_work: Theaetetus
stephanus_span: 210c
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0405
source_work: Theaetetus
stephanus_span: 210d
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0408
source_work: Theaetetus
stephanus_span: 161a
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
  ...
  start_char: 38752
  end_char: 39152
  text_sha256: c5c90813c4845bc7b5c7018d8102cb8d4b6b0ff1de73eb8c90a2e7119cf0f22b
greek_terms:
  - τρέφειν
  - ἀποτιθέναι
  - ἐλεγχόμενον
...
```yaml
observation_id: obs_theaetetus_0409
source_work: Theaetetus
stephanus_span: 161b
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0410
source_work: Theaetetus
stephanus_span: 161c
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0411
source_work: Theaetetus
stephanus_span: 167c-167e
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
  stephanus_span: 167c-167e
  start_marker: 167c
  ...
  start_char: 52020
  end_char: 53316
  text_sha256: eb2144369f6bb5e4dbfc661556ceee68aa65f2afa7ef70027beddca4868fa8a7
greek_terms:
  - χρηστὰ
  - πονηρῶν
  - σοφός
...
```yaml
observation_id: obs_theaetetus_0412
source_work: Theaetetus
stephanus_span: 167c-167e
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0413
source_work: Theaetetus
stephanus_span: 167c-167e
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0414
source_work: Theaetetus
stephanus_span: 171e-172b
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
  stephanus_span: 171e-172b
  start_marker: 171e
  ...
  start_char: 61428
  end_char: 62756
  text_sha256: 72d74ba6d4a4951bd587d537ab1a98cb8ef3a3b06fbbbb7c36d2be45f21f29a9
greek_terms:
  - οὐσία
  - φύσει
  - δόξαν
...
```yaml
observation_id: obs_theaetetus_0415
source_work: Theaetetus
stephanus_span: 171e-172b
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0416
source_work: Theaetetus
stephanus_span: 171e-172b
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0417
source_work: Theaetetus
stephanus_span: 181a-181c
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
  stephanus_span: 181a-181c
  start_marker: 181a
...
```yaml
observation_id: obs_theaetetus_0418
source_work: Theaetetus
stephanus_span: 181a-181c
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
...
```yaml
observation_id: obs_theaetetus_0419
source_work: Theaetetus
stephanus_span: 181a-181c
source_ref:
  source_path: raw/plato/greek/theaetetus.txt
