...
Greek-only reported-speech structure for all seven required outer turns in
`wiki/reported-turn-scopes.json`. Counterfactual-person cases remain unresolved
without invented owners; Meno and the Laconian collective resolve only where
the Greek identifies them. The Theognis verse at 95d-e is excluded as poetic
citation used inside Socrates' argument, not modeled as reported discourse.

Seventeen records remain accepted as seven atomic cohorts under the original
acceptance, the corrected scope receipt, and
`wiki/review/2026-08-30-meno-voice-claim-cutover.md`. The later receipt also
...
reviewed_attribution:
  ...
  context_span:
    start_char: 59362
    end_char: 59533
    text_sha256: 51a6e21a5babef5ddfc282f93e6229a1a3be89fb946a3fc38a8ff695e48467cf
  rationale: The same outer turn explicitly names οἱ Λάκωνες before φασίν and brackets their acclamation in two q pieces. The terminal owner is the Laconian collective; Socrates remains the reporting frame.
review_status: accepted
```
