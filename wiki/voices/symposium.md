...
voice_chain: ["ΑΠΟΛ.", "ΑΡΙΣΤΟΔ.", "ΣΩ."]
depth: 3
resolution: resolved
reviewed_attribution:
  kind: discourse_resolution
  candidate_owners: ["ΑΡΙΣΤΟΔ.", "ΣΩ."]
  context_span:
    start_char: 3680
    end_char: 4831
...
reviewed_attribution:
  kind: discourse_resolution
  candidate_owners: ["ΑΓΑ.", "ΑΡΙΣΤΟΦ.", "ΕΡΥ.", "ΠΑΥ."]
  context_span:
    start_char: 8623
    end_char: 8900
...
voice_chain: ["ΑΠΟΛ.", "ΑΡΙΣΤΟΔ.", "ΕΡΥ."]
depth: 3
resolution: resolved
reviewed_attribution:
  kind: discourse_resolution
  candidate_owners: ["ΑΓΑ.", "ΑΡΙΣΤΟΦ.", "ΕΡΥ.", "ΠΑΥ.", "ΦΑΙ."]
  context_span:
    start_char: 8600
    end_char: 9653
...
reviewed_attribution:
  kind: discourse_resolution
  candidate_owners: ["ΑΓΑ.", "ΕΡΥ.", "ΣΩ.", "ΦΑΙ."]
  context_span:
    start_char: 55380
    end_char: 56050
...
voice_chain: ["ΑΠΟΛ.", "ΑΡΙΣΤΟΔ.", "ΑΡΙΣΤΟΦ."]
depth: 3
resolution: resolved
evidence_refs:
  - kind: named_reporting_formula
...
voice_chain: ["ΑΠΟΛ.", "ΑΡΙΣΤΟΔ.", "ΑΡΙΣΤΟΦ.", "ΖΕΥΣ."]
depth: 4
resolution: resolved
evidence_refs:
  - kind: named_reporting_formula
...
voice_chain: ["ΑΠΟΛ.", "ΑΡΙΣΤΟΔ.", "ΑΡΙΣΤΟΦ.", "ΗΦΑΙ."]
depth: 4
resolution: resolved
evidence_refs:
  - kind: named_reporting_formula
...
voice_chain: ["ΑΠΟΛ.", "ΑΡΙΣΤΟΔ.", "ΣΩ.", "ΣΩ."]
depth: 4
resolution: resolved
reviewed_attribution:
  kind: discourse_resolution
  candidate_owners: ["ΔΙΟ.", "ΣΩ."]
  context_span:
    start_char: 61446
    end_char: 61558
...
voice_chain: ["ΑΠΟΛ.", "ΑΡΙΣΤΟΔ.", "ΣΩ.", "ΔΙΟ."]
depth: 4
resolution: resolved
reviewed_attribution:
  kind: discourse_resolution
...
voice_chain: ["ΑΠΟΛ.", "ΑΡΙΣΤΟΔ.", "ΑΛΚ.", "ΑΛΚ."]
depth: 4
resolution: resolved
reviewed_attribution:
  kind: discourse_resolution
  candidate_owners: ["ΑΛΚ.", "ΣΩ."]
  context_span:
    start_char: 95850
    end_char: 96100
...
voice_chain: ["ΑΠΟΛ.", "ΑΡΙΣΤΟΔ.", "ΕΡΥ.", "ΦΑΙ."]
depth: 4
resolution: resolved
evidence_refs:
  - kind: named_reporting_formula
...
voice_chain: ["ΑΠΟΛ.", "ΑΡΙΣΤΟΔ.", "ΑΛΚ.", "ΣΩ."]
depth: 4
resolution: resolved
evidence_refs:
  - kind: anchored_dialogue_turn
...
voice_chain: ["ΑΠΟΛ.", "ΓΛΑΥ."]
depth: 2
resolution: resolved
reviewed_attribution:
  kind: discourse_resolution
  candidate_owners: ["ΑΠΟΛ.", "ΓΛΑΥ."]
  context_span:
    start_char: 126
    end_char: 2181
