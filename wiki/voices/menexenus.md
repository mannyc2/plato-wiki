...
236d–249c printed frames; the fallen fathers' collective direct address is
resolved below it without flattening the enclosing Socrates–Aspasia chain.

All thirty-one records remain accepted as fourteen atomic cohorts under the
original acceptance and
`wiki/review/2026-08-30-menexenus-voice-claim-cutover.md`. The later receipt
also activates the claim-speaker cutover.
...
reviewed_attribution:
  ...
  context_span:
    start_char: 22923
    end_char: 25032
    text_sha256: 54ab6502ef2e0fcfa8dfe04beade22821ec2a3e8b6625e993976af8d678b7746
  rationale: The direct first-person-plural address is assigned to the fallen fathers and continues across the printed reset inside Aspasia's oration. The resolved chain preserves Socrates as reporter, Aspasia as orator, and the fathers as terminal owners.
review_status: accepted
```
...
reviewed_attribution:
  ...
  context_span:
    start_char: 25032
    end_char: 27020
    text_sha256: 6f39c8894b1fada980df690587fbf2dea41ae63ef0b0678e76fc3f42abb13e05
  rationale: The direct first-person-plural address is assigned to the fallen fathers and continues across the printed reset inside Aspasia's oration. The resolved chain preserves Socrates as reporter, Aspasia as orator, and the fathers as terminal owners.
review_status: accepted
```
...
reviewed_attribution:
  ...
  context_span:
    start_char: 27020
    end_char: 28956
    text_sha256: ccfb2d89375b19df001b2e58b180a8c71781fdd86c9af0b6fee52b14f4f0e907
  rationale: The direct first-person-plural address is assigned to the fallen fathers and continues across the printed reset inside Aspasia's oration. The resolved chain preserves Socrates as reporter, Aspasia as orator, and the fathers as terminal owners.
review_status: accepted
```
