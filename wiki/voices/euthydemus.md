...
voice_chain: ["ΣΩ.", "ΚΛΕΙΝ."]
depth: 2
resolution: resolved
reviewed_attribution:
  kind: discourse_resolution
  candidate_owners: ["ΚΛΕΙΝ.", "ΕΥΘ.", "ΔΙΟΝ."]
  context_span:
    start_char: 10363
    end_char: 10629
...
reviewed_attribution:
  kind: discourse_resolution
  candidate_owners: ["ΚΤΗΣ.", "ΕΥΘ.", "ΔΙΟΝ."]
  context_span:
    start_char: 26598
    end_char: 27231
...
reviewed_attribution:
  kind: discourse_resolution
  candidate_owners: ["ΕΥΘ.", "ΔΙΟΝ.", "ΚΤΗΣ."]
  context_span:
    start_char: 30788
    end_char: 30971
...
depth: 2
resolution: unresolved
candidate_owners: ["ΣΩ.", "ΕΥΘ.", "ΔΙΟΝ.", "ΚΤΗΣ."]
